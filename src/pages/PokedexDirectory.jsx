...
const PokedexDirectory = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col items-center bg-sky-blue lg:bg-poke-bg bg-no-repeat bg-contain'>
      <main className='flex flex-col items-center w-10/12 mt-8 gap-8 lg:w-7/12 lg:bg-dark-light-blue rounded-md lg:p-8'>
        <section className='w-full flex flex-col bg-white rounded-md p-4'>
        ...
        <section className='w-full bg-white rounded-md flex flex-col p-4 gap-4 lg:w-[60%]'>
          <h2 className='font-bold text-[20px] lg:text-[24px] text-center'>Native Pokédexes</h2>
          <p>
