  ...
  return (
    <div className='min-h-screen flex flex-col items-center bg-sky-blue lg:bg-poke-bg bg-no-repeat bg-contain'>
      <div className='w-10/12 lg:w-7/12 mt-8 rounded-md flex flex-col p-4 gap-8 items-center'>
        <h1
          className={`flex flex-row items-center justify-center capitalize text-[26px] font-bold bg-white text-${type?.name} w-full pt-2 pb-2 rounded-md`}>
          {type?.name}
        ...
        <div className='flex flex-col gap-4 p-4 bg-white rounded-md w-full'>
          <div className='flex flex-col gap-4'>
            <h1 className='font-bold text-[22px]'>Attack pros & cons</h1>
            <div className='flex flex-row'>
              <AiFillCheckCircle className='text-[#4caf50] text-[18px] mt-[0.1rem] w-[30px]' />
              <p className='ml-2 capitalize text-[15px]'>
            ...
            <div className='flex flex-row text-[15px]'>
              <AiFillCloseCircle className='text-[#f54f43] text-[18px] mt-[0.1rem] w-[30px]' />
          ...
          <div className='flex flex-col gap-4'>
            <h1 className='font-bold text-[22px]'>Defense pros & cons</h1>
            <div className='flex flex-row'>
              <AiFillCheckCircle className='text-[#4caf50] text-[18px] mt-[0.1rem] w-[30px]' />
